...
class DependencyGraphSorterTest {
    ...
    public void testRHPAMMasterNightlyCfg() {
        ...
        List<String> expected = [ "rhpam-build-bom", "droolsjbpm-build-bootstrap", "errai", "izpack", "kie-soup",
                                  ...
                                  "lienzo-tests", "appformer", "drools", "jbpm", "optaplanner", "kie-jpmml-integration",
                                  "rhba-boms", "optaweb-employee-rostering", "optaweb-vehicle-routing", "droolsjbpm-integration",
                                  "kie-wb-playground", "jbpm-work-items", "openshift-drools-hacep", "kie-wb-common", "drools-wb",
                                  "jbpm-designer", "optaplanner-wb", "jbpm-wb", "kie-wb-distributions", "rhba-license-builder",
                                  "rhba-common", "rhpam", "rhpam-installer", "rhpam-maven-repo-root"
                                ]
