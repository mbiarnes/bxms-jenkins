...
class ReleaseSingleJobBuilder {
    ...
    Job build(DslFactory dslFactory) {
        ...
        // commonTmp=3 will add all commonTmp ==0 will add nothing
        def releaseJobName=[
        "brew-repo-regen":1,
        "monitoring-cimessage":3,
        "create-handover":3,
        "create-product-tag":3,
        "release-notes":3,
        "export-openshift-images":1,
        "generate-qe-properties":1,
        "generate-sources":3,
        "init-release":2,
        "locate-import-list":3,
        "maven-repository-build":3,
        "mock-qe-smoketest-report":3,
        "openshift-test":0,
        "promote-release":1,
        "pvt-test":3,
        "send-handover-mail":1,
        "send-review-notification-mail":3,
        "stage-brew-build":3,
        "stage-bxms-patch":3,
        "start-brew-build":3,
        "trigger-qe-smoke-test":3,
        "update-product-jira":3,
        "validate-build-config":3,
        "validate-qe-properties":1,
        ]
        int commonTmp
        for (String thisjobName in releaseJobName.keySet()) {
            commonTmp=releaseJobName.get(thisjobName)
            dslFactory.job(release_code + "-release-pipeline/" + release_code +"-"+ thisjobName) {
                ...
                switch(thisjobName) {
                    ...
                    case "send-review-notification-mail":
                    ...
                    default:
                        description("null job,job create err")
                    break
                }
            }
        }
