                        ...
                        <tr> 
                            <td class="email-content-main mobile-expand " style="padding: 0px; border-collapse: collapse; border-left: 1px solid #ccc; border-right: 1px solid #ccc; border-top: 0; border-bottom: 0; padding: 0 15px 0 16px; background-color: #fff"> 
                                <table class="page-title-pattern" cellspacing="0" cellpadding="0" border="0" width="100%" style="border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt"> 
                                    <tr> 
                                        <td style="vertical-align: top;; padding: 0px; border-collapse: collapse; padding-right: 5px; font-size: 20px; line-height: 30px; mso-line-height-rule: exactly" class="page-title-pattern-header-container"> <span class="page-title-pattern-header" style="font-family: Arial, sans-serif; padding: 0; font-size: 20px; line-height: 30px; mso-text-raise: 2px; mso-line-height-rule: exactly; vertical-align: middle"> <a href="${brewchain_build_url}" style="color: #3b73af; text-decoration: none">${product_name} ${product_version} ${release_milestone}  chain build failed</a> </span> 
                                        </td> 
                                    </tr> 
                                </table> 
                            </td> 
...
job("sample-brew-build-fail") {
    ...
    publishers {
        ...
        extendedEmail {
            ...
            defaultSubject('[BxMS Release CI] ${product_name} ${product_version} ${release_milestone}  component build FAILED')
