...
/jboss-prod/tools/maven-3.3.9-prod/bin/mvn -Dmaven.repo.local=\${dev_maven_repo} \
    surefire-report:report -B -Dproduct.config=\${product1_smoketest_cfg} -Dproduct.version=\${product1_milestone_version} \
    -Dproduct.target=\${product1_shipped_file_deliver_version} -Dreport.filepath=\${product1_pvt_report_basename} clean package
