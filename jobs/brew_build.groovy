...
// Brew build script
def shellScript = '''#Reset the buld_counter and brew_build_url.
...
UNBLOCK=1 BREWCHAIN=1 CFG=./${release_prefix}.cfg POMMANIPEXT=brms-bom make -f  Makefile.BRMS bxms-maven-repo-root  2>&1| tee b.log 
