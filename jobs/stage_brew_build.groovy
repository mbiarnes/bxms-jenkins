...
override_version=\${product_version} 
#Uploading to rcm staging folder
if [ \${release_type} = "patch" ];then
    override_version=\${product_version}\${availability}
fi
if [ \${release_type} = "intpack" ];then
    ...
    ip-tooling/maven-to-stage.py --version=\${product_artifact_version} --override-version \${override_version} --maven-repo \${product_assembly_maven_repo_url} \
