...
if (PRODUCT_NAME == "intpack-fuse63-bxms64") {
    ...
    // sed command
    def command = 'sed -e \'s=rcm-guest.app.eng.bos.redhat.com/rcm-guest/staging/jboss-brms=download.devel.redhat.com/devel/candidates/INTPACK=g\' ${release_prefix}-deliverable-list-staging.properties >> ${release_prefix}-deliverable-list.properties'
    ...
    // sed command
    def command = 'sed -e \'s=rcm-guest.app.eng.bos.redhat.com/rcm-guest/staging/jboss-brms=download.devel.redhat.com/devel/candidates/BRMS=g\' -e \'s=rcm-guest.app.eng.bos.redhat.com/rcm-guest/staging/jboss-bpmsuite=download.devel.redhat.com/devel/candidates/BPMS=g\' brms-64-deliverable-list-staging.properties >> brms-64-deliverable-list.properties'

    // temp workaround for bpms
    def mavenToStageBpmsCommand = 'ip-tooling/maven-to-stage.py --version=\\${product_artifact_version} --override-version \\${product_version} \\\n' +
