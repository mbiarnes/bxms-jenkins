...
/mnt/maven-3.2.3-prod/bin/mvn clean site surefire-report:report -B -Dproduct.config=${brms_smoketest_cfg}  -Dproduct.version=${product_version}.${release_milestone} -Dproduct.target=${product_version}.GA
