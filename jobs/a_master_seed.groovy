...
ReleasePipelineBuilder("rhdm-70-nightly", "rhdm-70-dev.cfg", "/jboss-prod/config/rhdm-70-nightly-ci.properties", gerritBranch , gerritRefspec,currentJobName, "H 22 * * *")
...
ReleasePipelineBuilder("rhpam-71-nightly", "rhpam-71-dev.cfg", "/jboss-prod/config/rhpam-71-nightly-ci.properties", gerritBranch , gerritRefspec,currentJobName, "H 13 * * *" )
...
ReleasePipelineBuilder("rhpam-70-da-nightly", "rhpam-70-da-dev.cfg", "/jboss-prod/config/rhpam-70-da-nightly-ci.properties", gerritBranch , gerritRefspec,currentJobName, "H 17 * * *" )
...
JenkinsStandaloneJobsBuilder("rhdm-70", "/jboss-prod/config/rhdm-70-nightly-ci.properties", "rhdm-70-dev.cfg", "nightly" )
